run_app:
	...
	find pages_files -exec sed -i.bak 's|_dash-component-suites|tech-investment-analysis\\/_dash-component-suites|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-layout|tech-investment-analysis/_dash-layout.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-dependencies|tech-investment-analysis/_dash-dependencies.json|g' {} \;
	find pages_files -exec sed -i.bak 's|_reload-hash|tech-investment-analysis/_reload-hash|g' {} \;
	find pages_files -exec sed -i.bak 's|_dash-update-component|tech-investment-analysis/_dash-update-component|g' {} \;
	find pages_files -exec sed -i.bak 's|assets|tech-investment-analysis/assets|g' {} \;
